    ...
    <table id="todo_table" class="table w-full">
                    <thead>
                        <tr>
                            ...
                            <th class=" px-20 py-2 bg-orange-500 text-orange-100 rounded-tr-xl">Action</th>
                        </tr>
                    </thead>
                    <tbody >
                        ...
                        <tr class="odd:bg-orange-100 even:bg-orange-50 transition duration-300':'bg-green-100 line-through'} `">
                            <td class="text-center  px-1 py-2 text-orange-800">1</td>
                            <td class=" px-1 py-2 text-orange-800">hello</td>
                            <td class="text-center  px-1 py-2 text-orange-800 flex gap-3 justify-start">
                                <!-- <button class="text-orange-600 ml-20">
